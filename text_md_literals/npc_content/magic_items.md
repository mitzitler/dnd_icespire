...
This is a catalogue of all the items the players can encounter on this quest. This list will try to be balanced in terms of Uncommon/Rare status.
...
Sending:
- 3rd level
- Cost: action (material component not relevant)
- Range: unlimited
- Duration: 1 round
- School: evocation
...
Requires attunement from a wizard. This antiquated, cone-shaped hat is adorned with gold crescent moons and stars. While you are wearing it, you gain the following benefits:
...
From these, they should know that Halia has intentions to gather information on the gold mine, and hopefully they understand that Don-Jon is a pawn.
...
Not to be confused with the Hat of Wizardry, this hat offers a magic user an additional spell slot. However, the user is now vulnerable to cold, water and force damage.

### Coffer of Frustration
